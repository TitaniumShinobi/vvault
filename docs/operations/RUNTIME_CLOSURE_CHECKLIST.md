...
- Legacy external sources are extraction/offboarding provenance only.
...
Legacy references are allowed only when labeled as:
...
.venv/bin/python3 -m pytest tests/test_runtime_body_database_contract.py
