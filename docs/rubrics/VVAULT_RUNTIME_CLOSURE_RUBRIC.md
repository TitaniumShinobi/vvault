...
- legacy provenance with runtime authority
...
- Legacy dependencies are required for runtime readiness, auth, file storage, or body continuity.
...
Legacy references are allowed only as:
