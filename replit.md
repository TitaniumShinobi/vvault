...
- **VSI Folder Structure**: `instances/{construct}/{identity,config,chatty,chatgpt,character.ai,logs,assets,documents,memup,simDrive}/`, `library/{assets,documents}/`, `account/`, `system/`.
